...
class COC_Google_Ads {
    ...
    public static function init() {
        ...
        // in admin context where no customer cookies are available, so gclid/gbraid/wbraid
        // must be in order meta before the admin triggers the server-side conversion.
     ...
     * hook in "purchase on complete" mode — ensuring gclid/gbraid/wbraid are always
     * available when hook_purchase_on_complete fires later in admin context.
     */
